...
export class CustomerService {
  ...
  getCustomersMini() {
    return Promise.resolve(this.getCustomerData().slice(0, 5));
  }

  getCustomersSmall() {
    return Promise.resolve(this.getCustomerData().slice(0, 10));
  }

  getCustomersMedium() {
    return Promise.resolve(this.getCustomerData().slice(0, 50));
  }

  getCustomersLarge() {
    return Promise.resolve(this.getCustomerData().slice(0, 200));
  }
